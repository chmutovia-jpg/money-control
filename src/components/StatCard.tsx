...
export const StatCard = ({ label, value, icon: Icon, tone, hint }: StatCardProps) => (
  <div className="glass-panel liquid-hover rounded-5xl p-4 shadow-card sm:p-5">
    <div className="flex items-start justify-between gap-3 sm:gap-4">
      <div className="min-w-0">
        <p className="text-xs text-muted sm:text-sm">{label}</p>
        <p className="mt-2 break-words text-xl font-bold leading-tight text-ink sm:text-2xl">{value}</p>
